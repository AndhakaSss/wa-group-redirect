...
5. Go to "Settings" → "Environment Variables" and add:
   ...
   - `PUBLIC_BASE_URL` (will be `https://your-app.vercel.app` - Vercel gives you this)
   - `PORT` (Vercel sets this automatically, but you can set `3000` if needed)
6. Your app will be live at: `https://your-app.vercel.app`
7. **Static URL:** Vercel gives you a permanent URL like `https://your-app.vercel.app` that never changes!

**To get your static URL:**
- After deployment, Vercel automatically assigns you a URL
...
### Option 4: Railway.app (Alternative)
...
**Option B: Run on Vercel/Render (separate service)**
...
1. **Deploy web app** → Vercel/Render (free static URL)
